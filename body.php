  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner3n.jpg" alt="Los Angeles" style="width:100%;">
        
      </div>

      <div class="item">
        <img src="img/banner2n.jpg" style="width:100%;">
        
      </div>
    
      <div class="item">
        <img src="img/banner4n.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner1n.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner3n.jpg" alt="New York" style="width:100%;">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=25"><div class="shop">
							<div class="shop-img">
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=17"><div class="shop">
							<div class="shop-img">
								<img src="./img/gents-formal-250x250.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Mens<br>Collection</h3>
								<a href="product.php?p=17" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=15"><div class="shop">
							<div class="shop-img">
								<img src="./img/shutterstock_203611819.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Womens<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Kids</a></li>
